...
export const listarTodosTemporales = (): Promise<PermisoTemporal[]> =>
  apiGetData('/authorization/temporales');
...
export const listarTodasPermanentes = (): Promise<AutorizacionPermanente[]> =>
  apiGetData('/authorization/permanentes');
