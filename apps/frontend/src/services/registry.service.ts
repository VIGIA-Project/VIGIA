...
export const listarTodasPersonas = (): Promise<Persona[]> => apiGetData('/registry/personas');
export const listarTodosVehiculos = (): Promise<Vehiculo[]> => apiGetData('/registry/vehiculos');
export const crearVehiculo = (dto: import('./types/registry.types').CrearVehiculoDto): Promise<Vehiculo> => apiPostData('/registry/vehiculos', dto);
